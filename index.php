...
<body>
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/6133ae5ed6e7610a49b3a792/1feou28j6';
            s1.charset = 'UTF-8';
    ...
    <section class="banner">
        ...
        <div class="container">
            <h1 data-aos="fade-down" data-aos-delay="100" data-aos-duration="1000">Estudio Jurídico Parodi & Asoc</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-item" data-aos="fade-down" data-aos-delay="200" data-aos-duration="1000">
                    <div class="content">
                        ...
                        <ul>
                            ...
                            <li>Régimen de Comunicación
                            </li>
                            <li>Violencia de Género
                            </li>
                            <li>Violencia familiar
                            </li>
                            <li>Restricciones perimetrales
                            </li>
                            <li>Compensación Económica
                            </li>
                            <li>Liquidación de la sociedad conyugal
                            </li>
                            <li>
                ...
                <div class="col-lg-4 col-item" data-aos="fade-down" data-aos-delay="400" data-aos-duration="1000">
                    <div class="content">
                        ...
                        <hr>
                        <ul>
                            <li>Trabajo en negro o mal registrado
                            </li>
                            <li>Diferencias Salariales Conciliación Laboral (Seclo)
                            </li>
                            <li>Discriminación
                            </li>
                ...
                <div class="col-lg-4 col-item" data-aos="fade-down" data-aos-delay="500" data-aos-duration="1000">
                    <div class="content">
                        <div class="box">
                            <i class="fas fa-file-alt"></i>
                        </div>
                        <hr>
                        <h5 class="title">Derecho Sucesorio</h5>
                        <hr>
                        <ul>
                            <li>Declaratoria de Herederos
                            </li>
                            <li>Partición
                            </li>
                            <li>Ab-intestato
    ...
    <section class="speciality italy">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form action="contact.php" id="contactForm" method="post">
                        ...
                        <div class="form-group mt-3" data-aos="fade-down" data-aos-delay="200" data-aos-duration="1000">
                            <label for="">Email</label>
                            <input type="email" class="form-control" name="email" maxlength="60" placeholder="Email">
                        </div>
                        <div class="form-group mt-3" data-aos="fade-down" data-aos-delay="300" data-aos-duration="1000">
                            <label for="">Asunto</label>
                            <input type="text" class="form-control" name="subject" maxlength="60" placeholder="Asunto">
                        </div>
                        <div class="form-group mt-3" data-aos="fade-down" data-aos-delay="400" data-aos-duration="1000">
                            <label for="">Mensaje</label>
                            <textarea class="form-control" placeholder="Mensaje" maxlength="255" name="message" id="" cols="30" rows="10"></textarea>
                        </div>

                        <button class="btn btn-submit" data-aos="fade-down" data-aos-offset="-500" data-aos-delay="400" data-aos-duration="1000" type="button">Enviar</button>

                        <?php if ($_GET['status'] == 'ok') { ?>
                            <span class="text-success d-block mt-2">Mensaje enviado con exito!</span>
                        <?php } ?>
                    </form>
                </div>
                <div class="col-lg-4 col-info" data-aos="fade-down" data-aos-delay="300" data-aos-duration="1000">
                    <div class="content">
                        ...
                        <div class="item">
                            <i class="fab fa-instagram"></i> <label for=""><a target="_blank" href="https://www.instagram.com/estudiojuridicoparodiyasoc/">estudiojuridicoparodiyasoc</a></label>
                        </div>
                        <div class="item">
                            <i class="fab fa-facebook-square"></i><label for=""><a target="_blank" href="https://www.facebook.com/estudiojuridicoparodiyasociados">ESTUDIO
                                    JURIDICO PARODI &amp;
                                    ASOC</a></label>
                        </div>
                        <!-- <div class="item">
...
<script>
    ...
    $('.btn-submit').click(() => {
        ...
        if (name.length < 2 || name.length > 60) {
            ...
            cleanError('name', 'input');
        }


        if (subject.length < 2 || subject.length > 60) {
            form_errors = true;
            setError('subject', 'input');
        } else {
            cleanError('subject', 'input');
        }
    ...
    function setError(name, type) {
        let input = $(type + '[name="' + name + '"]');
        input.css('border', '1px solid red');
    }

    function cleanError(name, type) {
        let input = $(type + '[name="' + name + '"]');
